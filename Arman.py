...
Termux_Tricks/zf.py
@Tech-ZulfiQar-MaGsi
Tech-ZulfiQar-MaGsi Update zf.py
 1 contributor
1005 lines (968 sloc)  49.5 KB
# coding=utf-8
#!/usr/bin/python
# coding=utf-8
# coded by : ZulfiQar MaGsi
# https://www.facebook.com/Termux.King
...
def tech_abm():
    ...
    if username =="Z":
	    ...
	    os.system('xdg-open https://www.facebook.com/profile.php?id=100042965112748')
            time.sleep(1)
            tech_abm()
    else:
...
def clone_loginvia():
	...
	os.system('xdg-open https://www.facebook.com/javediqbalbalooch')
        time.sleep(1)
        menu()
    elif hack =="2":
        loginfb()
...
def menu():
    ...
    print("\033[1;97m[2]\033[1;91m-⋄-\033[1;97mClone From Chukhi")
